...
(function () {
  ...
  const ROULETTE_DISHES = [
    ...
    { name: 'Choripollo Burrito', desc: 'Chicken and chorizo with mozzarella, rice, and beans. Served with rice, beans, lettuce, and pico.', tag: 'Burrito' },
    { name: 'Shrimp Burrito', desc: 'Shrimp, mozzarella, rice, and beans in a large flour tortilla. Served with rice, beans, lettuce, and pico.', tag: 'Seafood' },
    { name: 'Burrito Mummia', desc: 'Steak and shrimp in a flour tortilla, wrapped in bacon, fried, with queso and chipotle.', tag: 'Burrito' },
    { name: 'Chimichanga Meal', desc: 'Fried flour tortilla with meat, mozzarella, and queso sauce. Served with rice, beans, lettuce, and pico.', tag: 'Chimichanga' },
    ...
    { name: 'Enchiladas', desc: 'Corn tortillas with your choice of meat, poblano salsa, and crumbled cheese.', tag: 'Enchiladas' },
    { name: 'Enchiladas Campechanas', desc: 'Enchiladas with steak, chorizo, poblano salsa, and crumbled cheese.', tag: 'Enchiladas' },
    { name: 'Queso Enchiladas', desc: 'Four corn tortillas with your choice of meat, covered in queso sauce and crumbled cheese. Served with lettuce and pico.', tag: 'Enchiladas' },
    ...
    { name: 'Gorditas', desc: 'Thick tortilla stuffed with your choice of meat, beans, lettuce, tomato, sour cream, and cheese.', tag: 'Antojitos' },
