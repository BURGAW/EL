...
(function () {
  ...
  window.SITE_PHOTOS = {
    ...
    categorySpotlight: {
      ...
      tortas: { src: groky('torta-2'), alt: 'Torta' },
      ...
      kids: { src: groky('torta-2'), alt: 'Kids plate' },
  ...
  const itemPhotos = {
    ...
    /* daily lunch */
    [photoKey('daily-lunch', 'LS Crunchy Tacos')]: blank(),
    [photoKey('daily-lunch', 'LS Tacos Crunchy')]: blank(),
    [photoKey('daily-lunch', 'LS Tacos')]: blank(),
    [photoKey('daily-lunch', 'LS Empanadas')]: blank(),
    [photoKey('daily-lunch', 'LS Enchiladas')]: blank(),
    [photoKey('daily-lunch', 'LS Quesadilla')]: blank(),
    [photoKey('daily-lunch', 'LS Half-Size Torta')]: blank(),
    [photoKey('daily-lunch', 'LS Torta Mediana')]: blank(),
    [photoKey('daily-lunch', 'LS Tamales')]: blank(),
    [photoKey('daily-lunch', 'LS Fajitas')]: blank(),
    [photoKey('daily-lunch', 'LS Fried Eggs')]: blank(),
    [photoKey('daily-lunch', 'LS Small ACP')]: blank(),
    [photoKey('daily-lunch', "LS Davey's Special")]: blank(),
    ...
    /* tortas */
    [photoKey('tortas', 'Torta')]: blank(),
    [photoKey('tortas', 'Torta Cubana')]: g('torta-2', 'Torta cubana'),
    [photoKey('tortas', 'Fried Steak Torta')]: blank(),
    [photoKey('tortas', 'Torta de Res Frita')]: blank(),
    ...
    [photoKey('daily-lunch', 'LS Huevos Fritos')]: blank(),
    [photoKey('daily-lunch', 'LS ACP Pequeño')]: blank(),
    [photoKey('daily-lunch', 'LS Especial Davey')]: blank(),
    [photoKey('daily-lunch', 'LS Tacos de Birria')]: blank(),
