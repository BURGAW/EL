...
(function () {
  ...
  const UI = {
    en: {
      ...
      viewDailyLunch: 'Daily Lunch (LS)',
      viewDinner: 'Dinner',
      heroBreakfast: 'Breakfast',
      heroBreakfastSub: 'Morning selections \u2014 eggs, burritos, chilaquiles & artisan plates.',
      heroDailyLunch: 'Daily Lunch (LS)',
      heroDailyLunchSub: 'LS = Lunch Size · 10 AM\u20133 PM \u2014 seasonal plates, prepared fresh daily.',
      heroDinner: 'Dinner',
    ...
    es: {
      ...
      viewDailyLunch: 'Almuerzo del D\u00eda (LS)',
      viewDinner: 'Cena',
      heroBreakfast: 'Desayuno',
      heroBreakfastSub: 'Selecci\u00f3n matutina \u2014 huevos, burritos, chilaquiles y m\u00e1s.',
      heroDailyLunch: 'Almuerzo del D\u00eda (LS)',
      heroDailyLunchSub: 'LS = Tama\u00f1o de almuerzo (Lunch Size) \u00b7 10 AM\u20133 PM \u2014 platos de temporada, frescos cada d\u00eda.',
      heroDinner: 'Cena',
